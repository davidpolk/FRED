...
const uint16_t L6474::prescalerArrayTimer2[PRESCALER_ARRAY_TIMER2_SIZE] = { 0, 1, 8, 64, 256, 1024};
 ...
 * @retval None
 **********************************************************/
void L6474::Begin(uint8_t nbShields, int nShield)
{
  ...
  pinMode(L6474_CS_1, OUTPUT);
  pinMode(L6474_CS_2, OUTPUT);
 ...
 **********************************************************/
int32_t L6474::GetMark(uint8_t shieldId, int nShield)
{
  return ConvertPosition(CmdGetParam(shieldId,L6474_MARK, nShield));
}
 ...
 **********************************************************/
int32_t L6474::GetPosition(uint8_t shieldId, int nShield)
{
  return ConvertPosition(CmdGetParam(shieldId,L6474_ABS_POS, nShield));
}
 ...
 * @retval None
 **********************************************************/
void L6474::GoHome(uint8_t shieldId, int nShield)
{
  GoTo(shieldId, 0, nShield);
} 
 ...
 * @retval None
 **********************************************************/
void L6474::GoMark(uint8_t shieldId, int nShield)
{
	uint32_t mark;

	mark = ConvertPosition(CmdGetParam(shieldId,L6474_MARK, nShield));
	GoTo(shieldId,mark, nShield);  
}
 ...
 * @retval None
 **********************************************************/
void L6474::GoTo(uint8_t shieldId, int32_t targetPosition, int nShield)
{
  dir_t direction;
  int32_t steps;
  ...
  {
    HardStop(shieldId, nShield);
  }

  /* Get current position */
  shieldPrm[shieldId].currentPosition = ConvertPosition(CmdGetParam(shieldId,L6474_ABS_POS, nShield));
  ...
  if (steps != 0) 
  {
    ...
    /* Motor activation */
    StartMovement(shieldId, nShield);
  }  
}
 ...
 * @retval None
 **********************************************************/
void L6474::HardStop(uint8_t shieldId, int nShield) 
{
  /* Disable corresponding PWM */
  PwmStop(shieldId);

  /* Disable power stage */
  CmdDisable(shieldId, nShield);
 ...
 * @retval None
 **********************************************************/
void L6474::Move(uint8_t shieldId, dir_t direction, uint32_t stepCount, int nShield)
{
  /* Eventually deactivate motor */
  if (shieldPrm[shieldId].motionState != INACTIVE) 
  {
 ...
 * @retval None
 **********************************************************/
void L6474::ResetAllShields(int nShield=0)
{
 	uint8_t loop;
 ...
 * @retval None
 **********************************************************/
void L6474::Run(uint8_t shieldId, dir_t direction, int nShield)
{
  /* Eventually deactivate motor */
  if (shieldPrm[shieldId].motionState != INACTIVE) 
  {
 ...
 * @retval None
 **********************************************************/
void L6474::SetHome(uint8_t shieldId, int nShield)
{
  CmdSetParam(shieldId, L6474_ABS_POS, 0, nShield);
}
 ...
 * @retval None
 **********************************************************/
void L6474::SetMark(uint8_t shieldId, int nShield)
{
  uint32_t mark = CmdGetParam(shieldId,L6474_ABS_POS, nShield);
  CmdSetParam(shieldId,L6474_MARK, mark, nShield);
}
 ...
 * @retval None
 **********************************************************/
void L6474::CmdDisable(uint8_t shieldId, int nShield)
{
  SendCommand(shieldId, L6474_DISABLE, nShield);
}
 ...
 * @retval None
 **********************************************************/
void L6474::CmdEnable(uint8_t shieldId, int nShield)
{
  SendCommand(shieldId, L6474_ENABLE, nShield);
}
 ...
 **********************************************************/
uint32_t L6474::CmdGetParam(uint8_t shieldId, L6474_Registers_t param, int nShield)
{
  uint32_t i;
  uint32_t spiRxData;
 ...
 **********************************************************/
uint16_t L6474::CmdGetStatus(uint8_t shieldId, int nShield)
{
  uint32_t i;
  uint16_t status;
  uint8_t spiIndex = numberOfShields - shieldId - 1;
  ...
  {
     WriteBytes(&spiTxBursts[i][0], &spiRxBursts[i][0], nShield);
  }
 ...
 * @retval None
 **********************************************************/
void L6474::CmdNop(uint8_t shieldId, int nShield)
{
  SendCommand(shieldId, L6474_NOP, nShield);
}
 ...
 **********************************************************/
uint16_t L6474::ReadStatusRegister(uint8_t shieldId, int nShield)
{
  return (CmdGetParam(shieldId,L6474_STATUS, nShield));
}
 ...
 * @retval None
 **********************************************************/
void L6474::SelectStepMode(uint8_t shieldId, L6474_STEP_SEL_t stepMod, int nShield)
{
  ...
  stepModeRegister = (uint8_t)(0xF8 & CmdGetParam(shieldId,L6474_STEP_MODE, nShield)) ;
  
  /* Apply new step mode */
  CmdSetParam(shieldId, L6474_STEP_MODE, stepModeRegister | (uint8_t)stepMod, nShield);

  /* Reset abs pos register */
  SetHome(shieldId, nShield);
}
 ...
 **********************************************************/
void L6474::StepClockHandler(uint8_t shieldId, int nShield)
{
  /* Set isr flag */
  isrFlag = true;
  ...
  {
    uint32_t AbsPos= ConvertPosition(CmdGetParam(shieldId,L6474_ABS_POS, nShield));
 ...
 * @retval None
 **********************************************************/
void L6474::SendCommand(uint8_t shieldId, uint8_t param, int nShield)
{
  uint8_t spiIndex = numberOfShields - shieldId - 1;
  bool itDisable = false;  
  ...
  WriteBytes(&spiTxBursts[3][0], &spiRxBursts[3][0], nShield); 
 ...
 * @retval None
 **********************************************************/
void L6474::SetRegisterToPredefinedValues(uint8_t shieldId, int nShield)
{
  ...
  switch (shieldId)
  {
    case 0:
      CmdSetParam(shieldId,
                        L6474_TVAL,
                        Tval_Current_to_Par(L6474_CONF_PARAM_TVAL_SHIELD_0), nShield);
      CmdSetParam(shieldId,
                        L6474_T_FAST,
                        (uint8_t)L6474_CONF_PARAM_TOFF_FAST_SHIELD_0 |
                        (uint8_t)L6474_CONF_PARAM_FAST_STEP_SHIELD_0, nShield);
      CmdSetParam(shieldId,
                        L6474_TON_MIN,
                        Tmin_Time_to_Par(L6474_CONF_PARAM_TON_MIN_SHIELD_0), nShield);
      CmdSetParam(shieldId,
                        L6474_TOFF_MIN,
                        Tmin_Time_to_Par(L6474_CONF_PARAM_TOFF_MIN_SHIELD_0), nShield);
      CmdSetParam(shieldId,
                        L6474_OCD_TH,
                        L6474_CONF_PARAM_OCD_TH_SHIELD_0, nShield);
      CmdSetParam(shieldId,
                        L6474_STEP_MODE,
                        (uint8_t)L6474_CONF_PARAM_STEP_SEL_SHIELD_0 |
                        (uint8_t)L6474_CONF_PARAM_SYNC_SEL_SHIELD_0, nShield);
      CmdSetParam(shieldId,
                        L6474_ALARM_EN,
                        L6474_CONF_PARAM_ALARM_EN_SHIELD_0, nShield);
      CmdSetParam(shieldId,
                        L6474_CONFIG,
                        ...
                        (uint16_t)L6474_CONF_PARAM_TOFF_SHIELD_0, nShield);
      break;
    case 1:
      CmdSetParam(shieldId,
                        L6474_TVAL,
                        Tval_Current_to_Par(L6474_CONF_PARAM_TVAL_SHIELD_1), nShield);
      CmdSetParam(shieldId,
                        L6474_T_FAST,
                        (uint8_t)L6474_CONF_PARAM_TOFF_FAST_SHIELD_1 |
                        (uint8_t)L6474_CONF_PARAM_FAST_STEP_SHIELD_1, nShield);
      CmdSetParam(shieldId,
                        L6474_TON_MIN,
                        Tmin_Time_to_Par(L6474_CONF_PARAM_TON_MIN_SHIELD_1), nShield);
      CmdSetParam(shieldId,
                        L6474_TOFF_MIN,
                        Tmin_Time_to_Par(L6474_CONF_PARAM_TOFF_MIN_SHIELD_1), nShield);
      CmdSetParam(shieldId,
                        L6474_OCD_TH,
                        L6474_CONF_PARAM_OCD_TH_SHIELD_1, nShield);
      CmdSetParam(shieldId,
                        L6474_STEP_MODE,
                        (uint8_t)L6474_CONF_PARAM_STEP_SEL_SHIELD_1 |
                        (uint8_t)L6474_CONF_PARAM_SYNC_SEL_SHIELD_1, nShield);
      CmdSetParam(shieldId,
                        L6474_ALARM_EN,
                        L6474_CONF_PARAM_ALARM_EN_SHIELD_1, nShield);
      CmdSetParam(shieldId,
                        L6474_CONFIG,
                        ...
                        (uint16_t)L6474_CONF_PARAM_TOFF_SHIELD_1, nShield);
      break;
    case 2:
      CmdSetParam(shieldId,
                        L6474_TVAL,
                        Tval_Current_to_Par(L6474_CONF_PARAM_TVAL_SHIELD_2), nShield);
      CmdSetParam(shieldId,
                        L6474_T_FAST,
                        (uint8_t)L6474_CONF_PARAM_TOFF_FAST_SHIELD_2 |
                        (uint8_t)L6474_CONF_PARAM_FAST_STEP_SHIELD_2, nShield);
      CmdSetParam(shieldId,
                        L6474_TON_MIN,
                        Tmin_Time_to_Par(L6474_CONF_PARAM_TON_MIN_SHIELD_2), nShield);
      CmdSetParam(shieldId,
                        L6474_TOFF_MIN,
                        Tmin_Time_to_Par(L6474_CONF_PARAM_TOFF_MIN_SHIELD_2), nShield);
      CmdSetParam(shieldId,
                        L6474_OCD_TH,
                        L6474_CONF_PARAM_OCD_TH_SHIELD_2, nShield);
      CmdSetParam(shieldId,
                        L6474_STEP_MODE,
                        (uint8_t)L6474_CONF_PARAM_STEP_SEL_SHIELD_2 |
                        (uint8_t)L6474_CONF_PARAM_SYNC_SEL_SHIELD_2, nShield);
      CmdSetParam(shieldId,
                        L6474_ALARM_EN,
                        L6474_CONF_PARAM_ALARM_EN_SHIELD_2, nShield);
      CmdSetParam(shieldId,
                        L6474_CONFIG,
                        ...
                        (uint16_t)L6474_CONF_PARAM_TOFF_SHIELD_2, nShield);
      break;
    default: ;
  }
}
 ...
 * @retval None
 **********************************************************/
void L6474::WriteBytes(uint8_t *pByteToTransmit, uint8_t *pReceivedByte, int nShield)
{
  if (nShield == 0){
    digitalWrite(L6474_CS_1, LOW);
  }
  if (nShield == 1) {
    digitalWrite(L6474_CS_2, LOW);
  }
  ...
  digitalWrite(L6474_CS_1, HIGH);
  digitalWrite(L6474_CS_2, HIGH);
...
void L6474::Pwm2SetFreq(uint16_t newFreq)
{
  ...
  ICR3 = (uint16_t)top;
  OCR3A = ((uint16_t)top) >> 1; // Set a 50 % duty cycle
 ...
 * @retval None
 **********************************************************/
void L6474::SetShieldParamsToPredefinedValues(int nShield)
{
  ...
  {
    SetRegisterToPredefinedValues(i, nShield);
  }   
}
 ...
 * @retval None
 **********************************************************/
void L6474::StartMovement(uint8_t shieldId, int nShield)  
{
  /* Enable L6474 powerstage */
  CmdEnable(shieldId, nShield);
...
ISR(TIMER1_OVF_vect) 
{
  ...
  {  
    ...
    {
      instancePtr->StepClockHandler(0, 0);
    }
  }
}
 ...
 ISR(TIMER2_OVF_vect) 
{
  ...
  {  
    ...
    {
      instancePtr->StepClockHandler(1, 0);
    }
  }
}
